...
from tnsr.tnsr_base_surface_model import SurfaceNSRModel, SurfaceNSRModelConfig


@dataclass
class NeuSNSRModelConfig(SurfaceNSRModelConfig):
    """NeuS Model Config"""

    _target: Type = field(default_factory=lambda: NeuSNSRModel)
    num_samples: int = 64
...
class NeuSNSRModel(SurfaceNSRModel):
    """NeuS model
